...
parameters
 ...
 i60_1stgen_bioenergy_dem_acc(t,i)                Regional 1st generation bioenergy demand accumulated (mio. GJ per yr)
 i60_bioenergy_subsidy(t)                         Bioenergy subsidy per year (USD05MER per GJ)
...
positive variables
 ...
 v60_1stgen_bioenergy_dem(i,kall)           Regional 1st generation bioenergy demand (mio. GJ per yr)
...
equations
 ...
 q60_bioenergy_1st(i)                      Regional 1st generation dedicated bioenergy demand (mio. GJ per yr)
...
parameters
 ...
 ov60_1stgen_bioenergy_dem(t,i,kall,type)           Regional 1st generation bioenergy demand (mio. GJ per yr)
 ...
 oq60_bioenergy_1st(t,i,type)                       Regional 1st generation dedicated bioenergy demand (mio. GJ per yr)
