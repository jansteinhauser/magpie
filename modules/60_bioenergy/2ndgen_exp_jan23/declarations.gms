...
parameters
 ...
 i60_1stgen_bioenergy_subsidy(t)                 1st Gen Bioenergy subsidy per year (USD05MER per GJ)
...
parameters
 ...
 ov60_prod_bioen(t,i,kall,type)                     Regional bioenergy demand  (mio. GJ per yr)
 ...
 oq60_biomar(t,i,kall,type)                         Global total bioenergy demand (mio. GJ per yr) 
;
