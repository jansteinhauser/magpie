...
*'  + sum((kbe60,ct), vm_dem_bioen(i2,kbe60)* fm_attributes("ge",kbe60) * (-i60_2ndgen_bioenergy_subsidy(ct)));
    =e= (sum(k1st60, vm_dem_bioen(i2,k1st60) * fm_attributes("ge",k1st60)) 
        + sum(kbe60, vm_dem_bioen(i2,kbe60)) * fm_attributes("ge",kbe60))
        * sum(ct, -i60_2ndgen_bioenergy_subsidy(ct));