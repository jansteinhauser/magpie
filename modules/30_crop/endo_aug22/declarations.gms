...
equations
 ...
 q30_crop_reg(i)                  Total regional crop production area (Mha)
 q30_crop_glo                     Total global crop production area (Mha)
;
...
parameters
 ...
 oq30_crop_reg(t,i,type)                  Total regional crop production area (Mha)
 oq30_crop_glo(t,type)                    Total global crop production area (Mha)
;
