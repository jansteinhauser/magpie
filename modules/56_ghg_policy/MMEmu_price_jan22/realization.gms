...
$Ifi "%phase%" == "sets" $include "./modules/56_ghg_policy/MMEmu_price_jan22/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/56_ghg_policy/MMEmu_price_jan22/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/56_ghg_policy/MMEmu_price_jan22/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/56_ghg_policy/MMEmu_price_jan22/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/56_ghg_policy/MMEmu_price_jan22/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/56_ghg_policy/MMEmu_price_jan22/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/56_ghg_policy/MMEmu_price_jan22/postsolve.gms"
