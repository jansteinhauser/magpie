...
elseif (m_year(t_all) >= 2100),
    im_pollutant_prices(t_all,i,"co2_c") = (44 / 12) * s56_ghgprice_target;
    im_pollutant_prices(t_all,i,"ch4") = 28 * s56_ghgprice_target;
    im_pollutant_prices(t_all,i,"n2o_n_direct") = 265 * (44 / 28) * s56_ghgprice_target;
    im_pollutant_prices(t_all,i,"n2o_n_indirect") = 265 * (44 / 28) * s56_ghgprice_target;
else
    im_pollutant_prices(t_all,i,"co2_c") = (44 / 12) * s56_ghgprice_target /(2100 - s56_ghgprice_start) * (m_year(t_all) - s56_ghgprice_start);
    im_pollutant_prices(t_all,i,"ch4") = 28 * s56_ghgprice_target /(2100 - s56_ghgprice_start) * (m_year(t_all) - s56_ghgprice_start);
    im_pollutant_prices(t_all,i,"n2o_n_direct") = 265 * (44 / 28) * s56_ghgprice_target /(2100 - s56_ghgprice_start) * (m_year(t_all) - s56_ghgprice_start);
    im_pollutant_prices(t_all,i,"n2o_n_indirect") = 265 * (44 / 28) * s56_ghgprice_target /(2100 - s56_ghgprice_start) * (m_year(t_all) - s56_ghgprice_start);
 );
);
