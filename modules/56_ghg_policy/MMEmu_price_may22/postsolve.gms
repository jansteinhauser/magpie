...
if ((m_year(t) >=  s56_ghgprice_start),
    p56_emissions_taxed_cumulative(i) = p56_emissions_taxed_cumulative(i) + v56_emissions_taxed_reg.l(i) * m_yeardiff(t);
);
...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov56_emissions_taxed_reg(t,i,"marginal")                 = v56_emissions_taxed_reg.m(i);
 ...
 oq56_regional_emissions(t,i,"marginal")                  = q56_regional_emissions.m(i);
 ...
 ov56_emissions_taxed_reg(t,i,"level")                    = v56_emissions_taxed_reg.l(i);
 ...
 oq56_regional_emissions(t,i,"level")                     = q56_regional_emissions.l(i);
 ...
 ov56_emissions_taxed_reg(t,i,"upper")                    = v56_emissions_taxed_reg.up(i);
 ...
 oq56_regional_emissions(t,i,"upper")                     = q56_regional_emissions.up(i);
 ...
 ov56_emissions_taxed_reg(t,i,"lower")                    = v56_emissions_taxed_reg.lo(i);
 ...
 oq56_regional_emissions(t,i,"lower")                     = q56_regional_emissions.lo(i);
