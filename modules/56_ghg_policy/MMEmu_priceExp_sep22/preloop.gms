...
elseif (m_year(t_all) >= 2100),
    ...
    im_pollutant_prices(t_all,i,"co2_c",emis_source) = (44 / 12) * s56_ghgprice_target ** (1/(2100 - s56_ghgprice_start)) ** (m_year(t_all) - s56_ghgprice_start);
    im_pollutant_prices(t_all,i,"ch4",emis_source) = 28 * s56_ghgprice_target ** (1/(2100 - s56_ghgprice_start)) ** (m_year(t_all) - s56_ghgprice_start);
    im_pollutant_prices(t_all,i,"n2o_n_direct",emis_source) = 265 * (44 / 28) * s56_ghgprice_target ** (1/(2100 - s56_ghgprice_start)) ** (m_year(t_all) - s56_ghgprice_start);
    im_pollutant_prices(t_all,i,"n2o_n_indirect",emis_source) = 265 * (44 / 28) * s56_ghgprice_target ** (1/(2100 - s56_ghgprice_start)) ** (m_year(t_all) - s56_ghgprice_start);
 );
);
