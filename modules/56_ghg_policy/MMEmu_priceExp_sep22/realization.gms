...
$Ifi "%phase%" == "sets" $include "./modules/56_ghg_policy/MMEmu_priceExp_sep22/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/56_ghg_policy/MMEmu_priceExp_sep22/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/56_ghg_policy/MMEmu_priceExp_sep22/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/56_ghg_policy/MMEmu_priceExp_sep22/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/56_ghg_policy/MMEmu_priceExp_sep22/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/56_ghg_policy/MMEmu_priceExp_sep22/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/56_ghg_policy/MMEmu_priceExp_sep22/postsolve.gms"
